...
'pacman' => array (
		...
		'depends_lfs' => 'blfs.09.libarchive>=3.1.2:blfs.17.curl>=7.19.4:blfs.04.gpgme:notlfs.pm.archlinux-keyring',
		'depends_notlfs' => 'blfs.09.libarchive>=3.1.2:blfs.17.curl>=7.19.4:blfs.04.gpgme:notlfs.pm.archlinux-keyring'
	),
